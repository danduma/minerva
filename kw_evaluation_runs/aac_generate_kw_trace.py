...
def main():
    ...
    if to_generate.startswith("training"):
        ...
        experiment["load_preselected_test_files_list"] = "train_guids_aac_c6.txt"
        ...
        experiment["load_preselected_test_files_list"] = "test_guids_c3_aac_desktop.txt"
        experiment["name"] = "aac_generate_kw_trace_TEST"
        experiment["max_queries_generated"] = 1000

        experiment["precomputed_queries_filename"] = "precomputed_queries_new1k.json"
