# Experiments with the PMC corpus like the ones for LREC'16
#
...
experiment = {
    "name": "pmc_full_text_kw_selection",
    "description":
        "Full-text indexing of PMC to test kw selection",
    ...
    "precomputed_queries_filename": "precomputed_queries_test.json",
    "files_dict_filename": "files_dict_test.json",

    "load_preselected_test_files_list": "test_guids_pmc_c3_1k.txt",
    ...
    "features_index_name": "az_ilc_az_annotated_pmc_2013_1",
...
def main():
    ...
    # from evaluation.kw_annot_eval_pipeline import WRITER_NAME
    # import os
