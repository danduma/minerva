...
from general_utils import getSafeFilename, exists
...
files_dict_filename="files_dict.json", testing_methods=None, runtime_parameters=None, logging=True, full_corpus=False, compare_explain=False):
    ...
    logger.output_filename=Corpus.dir_output+output_filename

    precomputed_queries=json.load(open(Corpus.dirprebuiltBOWs+precomputed_queries_filename,"r"))
    files_dict=json.load(open(Corpus.dirprebuiltBOWs+files_dict_filename,"r"))
...
##                    assert(False,"window method type not implemented")
    ...
    json.dump(precomputed_queries,open(Corpus.dirprebuiltBOWs+filename,"w"))
    ...
    json.dump(files_dict,open(Corpus.dirprebuiltBOWs+files_dict_filename,"w"))
    json.dump(queries_by_az,open(Corpus.dirprebuiltBOWs+"queries_by_az.json","w"))
    json.dump(queries_by_cfc,open(Corpus.dirprebuiltBOWs+"queries_by_cfc.json","w"))
...
def createExplainQueriesByAZ(retrieval_results_filename="prr_all_ilc_AZ_paragraph_ALL.json"):
    ...
    """
    retrieval_results=json.load(open(Corpus.dirprebuiltBOWs+retrieval_results_filename,"r"))
...
##        retrieval_results_by_cfc[retrieval_result["query"]["cfc"]].append(retrieval_result)
    ...
    json.dump(retrieval_results_by_az,open(Corpus.dirprebuiltBOWs+"retrieval_results_by_az.json","w"))
##    json.dump(retrieval_results_by_cfc,open(Corpus.dirprebuiltBOWs+"retrieval_results_by_cfc.json","w"))
...
retrieval_results_filename="", use_default_similarity=False):
    ...
    files_dict=json.load(open(Corpus.dirprebuiltBOWs+files_dict_filename,"r"))
    precomputed_queries=json.load(open(Corpus.dirprebuiltBOWs+"precomputed_queries.json","r"))

##    queries_by_az=json.load(open(Corpus.dirprebuiltBOWs+"queries_by_az.json","r"))
##    queries_by_cfc=json.load(open(Corpus.dirprebuiltBOWs+"queries_by_cfc.json","r"))
...
##    json.dump(results,open(Corpus.dirprebuiltBOWs+retrieval_results_filename,"w"))
        manualJSONdump(results,open(Corpus.dirprebuiltBOWs+"prr_"+retrieval_results_filename+"_"+doc_method+".json","w"))
        json.dump(retrieval_results_by_az,open(Corpus.dirprebuiltBOWs+"prr_by_az_"+retrieval_results_filename+"_"+doc_method+".json","w"))
...
testing_methods=None, filename_add="", files_dict_filename="files_dict.json",split_set=None):
    ...
    files_dict=json.load(open(Corpus.dirprebuiltBOWs+files_dict_filename,"r"))
##    retrieval_results=json.load(open(Corpus.dirprebuiltBOWs+retrieval_results_filename,"r"))
    retrieval_results_by_az=json.load(open(Corpus.dirprebuiltBOWs+"retrieval_results_by_az.json","r"))
...
def fixDumping(retrieval_results_filename="precomputed_retrieval_results.json"):
    import cPickle
    results=cPickle.load(open(Corpus.dirprebuiltBOWs+"test.pic","r"))
    json.dump(results,open(Corpus.dirprebuiltBOWs+retrieval_results_filename,"w"))
    createExplainQueriesByAZ()
