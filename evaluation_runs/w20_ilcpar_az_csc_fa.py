...
##
##    "inlink_context":{"type":"inlink_context", "index":"inlink_context",
##        "parameters": [10, 20, 30], "runtime_parameters":{"inlink_context":"1"}},
##
##    "inlink_context_year":{"type":"inlink_context", "index":"inlink_context_year",
##        "parameters": [10, 20, 30], "runtime_parameters":{"inlink_context":"1"}},
##
...
##    "ilc_AZ":{"type":"inlink_context", "index":"ilc_AZ", "parameters":["paragraph","1up_1down","1up","1only"], "runtime_parameters":
##        {
...
##        "AZ":["ilc_AZ_"+zone for zone in AZ_ZONES_LIST],
...
def main():
    experiment={
        "name":"w20_ilcpar_az_csc_fa",
        "description":"Correlation of sentences in the paragraph that the incoming link citation occurs in, each in a BOW according to its class. AZ - CSC",
        ...
        "split_into":[],
        "full_corpus":False,
        "type":"train_weights", #"compute_once"
        "numchunks":20,
        "output_filename":"results.csv",
        "pivot_table":"",
        "queries_to_process":["ALL"],
        "queries_classification":"AZ",
        "train_weights_for":AZ_ZONES_LIST,
