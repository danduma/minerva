# Read XML output from Cermine into a reference format as used by SciDocJSON
#
...
class CermineReader:
    ...
    def loadCermineReference(self, reference):
        """
    ...
    def readReferences(self, root_node):
        ...
        if root_node:
            for reference in root_node.findAll("citation"):
                references.append(self.loadCermineReference(reference))
        return references
