...
def prebuildMulti(method_name, parameters, prebuild_function, doc, doctext, guid, overwrite_existing_bows, filter_options, force_rebuild=False):
    """
    ...
    if len(params) > 0:
        ...
        all_bows = prebuild_function(doc, parameters=params, doctext=doctext, filter_options=filter_options, force_rebuild=force_rebuild)
