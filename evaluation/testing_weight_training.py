...
class LuceneWeightTrainingPipeline(LuceneTestingPipeline):
    """
    """
    def __init__(self):
        pass
    ...
    def autoTrainWeightValues(self, zones_to_process=AZ_ZONES_LIST, files_dict_filename="files_dict.json", testing_methods=None, filename_add=""):
        """
    ...
    def autoTrainWeightValues_optimized(self, exp,split_set=None):
        """
    ...
    def dynamicWeightValues(self, exp,split_fold):
        """
